...
object CookiePolicy:
   ...
   */
  @static val ACCEPT_ALL: CookiePolicy = new CookiePolicy:
    override def shouldAccept(uri: URI, cookie: HttpCookie): Boolean = true

  /**
   * One pre-defined policy which accepts no cookies.
   */
  @static val ACCEPT_NONE: CookiePolicy = new CookiePolicy:
   ...
   */
  @static val ACCEPT_ORIGINAL_SERVER: CookiePolicy = new CookiePolicy:
