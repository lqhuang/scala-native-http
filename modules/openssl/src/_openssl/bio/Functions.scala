...
private[openssl] trait Functions:
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_ctrl(bp: Ptr[BIO], cmd: BIO_CTRL, larg: Size, parg: Ptr[Byte]): Size =
    extern
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_do_connect_retry(bio: Ptr[BIO], timeout: CInt, nap_milliseconds: CInt): CInt =
    extern
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_dump_indent_fp(fp: Ptr[FILE], s: Ptr[Byte], len: CInt, indent: CInt): CInt =
    extern
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_meth_set_create(biom: Ptr[BIO_METHOD], create: CFuncPtr1[Ptr[BIO], CInt]): CInt =
    extern
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_snprintf(buf: CString, n: size_t, format: CString, rest: CVarArgList): CInt =
    extern
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_vprintf(bio: Ptr[BIO], format: CString, args: CVarArgList): CInt =
    extern

  /**
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_vsnprintf(buf: CString, n: size_t, format: CString, args: CVarArgList): CInt =
    extern

  /**
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_wait(bio: Ptr[BIO], max_time: time_t, nap_milliseconds: CUnsignedInt): CInt =
    extern
   ...
   * [bindgen] header: /usr/include/openssl/bio.h
   */
  def BIO_write_ex(b: Ptr[BIO], data: Ptr[Byte], dlen: size_t, written: Ptr[size_t]): CInt =
    extern
