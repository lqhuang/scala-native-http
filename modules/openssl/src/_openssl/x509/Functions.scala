...
private[openssl] trait Functions:
  ...
  @extern def i2d_X509_NAME(a: Ptr[BIO], ppout: Ptr[Ptr[CUnsignedChar]]): CInt = extern

  @extern def i2d_X509_NAME_bio(bp: Ptr[BIO], req: Ptr[X509_NAME]): CInt = extern

  @extern def i2d_X509_NAME_fp(fp: Ptr[FILE], req: Ptr[X509_NAME]): CInt = extern

  @extern def d2i_X509_NAME(
      a: Ptr[Ptr[X509_NAME]],
      pp: Ptr[Ptr[CUnsignedChar]],
      length: CLongInt,
