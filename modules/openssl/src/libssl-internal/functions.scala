...
object functions:
  ...
  import _root_.snhttp.experimental.openssl.libssl.internal.aliases.*
  import _root_.snhttp.experimental.openssl.libssl.internal.structs.*
  import _root_.snhttp.experimental.openssl.libssl.internal.enumerations.*
  import _root_.snhttp.experimental.openssl.libssl.internal.unions.*
  ...
  private[libssl] def __sn_wrap_snhttp_experimental_openssl_ssl_SSL_as_poll_descriptor(
      s: Ptr[SSL],
