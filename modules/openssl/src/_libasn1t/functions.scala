 ...
 * [bindgen] header: /usr/include/openssl/asn1.h
 */
@extern def ASN1_buf_print(bp: Ptr[BIO], buf: Ptr[CUnsignedChar], buflen: size_t, off: CInt): CInt =
  extern
 ...
 * [bindgen] header: /usr/include/openssl/asn1.h
 */
@extern def ASN1_const_check_infinite_end(p: Ptr[Ptr[CUnsignedChar]], len: CLongInt): CInt = extern
 ...
 * [bindgen] header: /usr/include/openssl/asn1.h
 */
@extern def ASN1_dup(i2d: Ptr[i2d_of_void], d2i: Ptr[d2i_of_void], x: Ptr[Byte]): Ptr[Byte] = extern
 ...
 * [bindgen] header: /usr/include/openssl/asn1.h
 */
@extern def ASN1_item_d2i_bio(it: Ptr[ASN1_ITEM], in: Ptr[BIO], pval: Ptr[Byte]): Ptr[Byte] = extern
 ...
 * [bindgen] header: /usr/include/openssl/asn1.h
 */
@extern def BN_to_ASN1_ENUMERATED(bn: Ptr[BIGNUM], ai: Ptr[ASN1_ENUMERATED]): Ptr[ASN1_ENUMERATED] =
  extern
 ...
 * [bindgen] header: /usr/include/openssl/asn1.h
 */
@extern def a2i_ASN1_INTEGER(bp: Ptr[BIO], bs: Ptr[ASN1_INTEGER], buf: CString, size: CInt): CInt =
  extern
